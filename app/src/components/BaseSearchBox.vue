  ...
  <div class="w-full">
    <Combobox v-model="selected">
      <div class="relative mt-1">
        ...
        >
          <ComboboxInput
            class="w-full border-none py-2 pl-3 pr-10 text-base font-bold leading-5 text-purple-900 focus:ring-0"
        ...
        >
          <ComboboxOptions
            class="absolute mt-1 max-h-48 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
          >
            <div
